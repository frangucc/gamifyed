...
namespace odb
{
  ...
  struct access::object_traits_impl< ::std::Database, id_sqlite >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::std::Database, id_sqlite >::id_type
  access::object_traits_impl< ::std::Database, id_sqlite >::
  ...
  bool access::object_traits_impl< ::std::Database, id_sqlite >::
  grow (image_type& i,
        bool* t)
  {
  ...
  const char access::object_traits_impl< ::std::Database, id_sqlite >::table_name[] =
  "\"Database\"";
  ...
  access::object_traits_impl< ::std::Database, id_sqlite >::pointer_type
  access::object_traits_impl< ::std::Database, id_sqlite >::
  ...
  result< access::object_traits_impl< ::std::Database, id_sqlite >::object_type >
  access::object_traits_impl< ::std::Database, id_sqlite >::
  ...
  unsigned long long access::object_traits_impl< ::std::Database, id_sqlite >::
  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("DROP TABLE IF EXISTS \"Database\"");
          return false;
        }
      }
    }
